...
#define IP2_LANGUAGE_FN_PARSE_PARAMS_2(P,p0,p1) IP2_FX(LANGUAGE_FN_PARSE_PARAM_TYPES_2, (,PP2_DEF_##p0,PP2_DEF_##p1))
#define IP2_LANGUAGE_FN_PARSE_PARAMS_3(P,p0,p1,p2) IP2_FX(LANGUAGE_FN_PARSE_PARAM_TYPES_3, (,PP2_DEF_##p0,PP2_DEF_##p1,PP2_DEF_##p2))
...
#define IP2_LANGUAGE_FN_PARSE_PARAM_TYPES_1(P,i0,a0,t0) \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t0 ()),P##i0,P##a0
#define IP2_LANGUAGE_FN_PARSE_PARAM_TYPES_2(P,i0,a0,t0, i1,a1,t1) \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t0 ()),P##i0,P##a0, \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t1 ()),P##i1,P##a1
#define IP2_LANGUAGE_FN_PARSE_PARAM_TYPES_3(P,i0,a0,t0, i1,a1,t1, i2,a2,t2) \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t0 ()),P##i0,P##a0, \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t1 ()),P##i1,P##a1 \
        IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(IP2_LANGUAGE_FN_TEST_IF_NOT_REF P##t2 ()),P##i2,P##a2

#define IP2_LANGUAGE_FN_CHOOSE_PARAM_TYPE(...) PP2_TUPLE_AT_1(,__VA_ARGS__,8PP2_LANGUAGE_FN_ARG_R)
#define IP2_LANGUAGE_FN_TEST_IF_NOT_REF(...) ,8PP2_LANGUAGE_FN_ARG_V,
